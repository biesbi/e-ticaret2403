    ...
    public static function get(?string $userId, ?string $sessionId): array
    {
        ...
        foreach ($rows as $row) {
            ...
            $items[] = [
                ...
                'set_no' => $row['set_no'],
                'product_condition' => normalizeProductConditionTag($row['product_condition'] ?? null, '2. El Sıfır'),
                'condition_tag' => normalizeProductConditionTag($row['product_condition'] ?? null, '2. El Sıfır'),
                'conditionLabel' => productConditionDisplayLabel(normalizeProductConditionTag($row['product_condition'] ?? null, '2. El Sıfır')),
